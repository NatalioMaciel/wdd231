...
function createCourses(coursesToShow) {
    const coursesdiv = document.querySelector(".coursestag");
    ...
    totalCreditsDiv.textContent = `The total number of courses listed below is: ${totalCredits}`;
}
